...
#if !defined( _LIBHIBR_TYPES_H )
#define _LIBHIBR_TYPES_H
...
#define __USE_UNIX98
#define LIBHIBR_DEFINITION_UNIX98
#endif

#include <wchar.h>

#if defined( LIBHIBR_DEFINITION_UNIX98 )
#undef __USE_UNIX98
#undef LIBHIBR_DEFINITION_UNIX98
#endif
...
#endif /* !defined( _LIBHIBR_TYPES_H ) */
