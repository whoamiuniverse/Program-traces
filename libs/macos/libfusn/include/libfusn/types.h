...
#if !defined( _LIBFUSN_TYPES_H )
#define _LIBFUSN_TYPES_H
...
#define __USE_UNIX98
#define LIBFUSN_DEFINITION_UNIX98
#endif

#include <wchar.h>

#if defined( LIBFUSN_DEFINITION_UNIX98 )
#undef __USE_UNIX98
#undef LIBFUSN_DEFINITION_UNIX98
#endif
...
#endif /* !defined( _LIBFUSN_TYPES_H ) */
