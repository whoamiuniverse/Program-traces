...
#if !defined( _LIBWTCDB_DEFINITIONS_H )
#define _LIBWTCDB_DEFINITIONS_H

#include <libwtcdb/types.h>

#define LIBWTCDB_VERSION		20251203

/* The version string
 */
#define LIBWTCDB_VERSION_STRING		"20251203"
...
#endif /* !defined( _LIBWTCDB_DEFINITIONS_H ) */
