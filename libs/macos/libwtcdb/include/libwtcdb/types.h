...
#if !defined( _LIBWTCDB_TYPES_H )
#define _LIBWTCDB_TYPES_H
...
#define __USE_UNIX98
#define LIBWTCDB_DEFINITION_UNIX98
#endif

#include <wchar.h>

#if defined( LIBWTCDB_DEFINITION_UNIX98 )
#undef __USE_UNIX98
#undef LIBWTCDB_DEFINITION_UNIX98
#endif
...
#endif /* !defined( _LIBWTCDB_TYPES_H ) */
