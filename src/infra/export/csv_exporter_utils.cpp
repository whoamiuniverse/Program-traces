...
std::string normalizeEvidenceSource(std::string source) {
  ...
  static const std::unordered_map<std::string, std::string_view>
      kCanonicalEvidenceSources = {
          ...
          {"app compat flags", "AppCompatFlags"},
          {"typedpaths", "TypedPaths"},
          {"typed paths", "TypedPaths"},
          {"lastvisitedmru", "LastVisitedMRU"},
          {"last visited mru", "LastVisitedMRU"},
          {"opensavemru", "OpenSaveMRU"},
          {"open save mru", "OpenSaveMRU"},
          ...
          {"timeline", "Timeline"},
          {"bits", "BITS"},
          {"psconsolehistory", "PSConsoleHistory"},
          {"ps console history", "PSConsoleHistory"},
          ...
          {"security4688", "Security4688"},
          {"security4624", "Security4624"},
          {"security4672", "Security4672"},
          {"securitycorrelation", "SecurityCorrelation"},
          {"jumplist", "JumpList"},
          {"jump list", "JumpList"},
          {"lnkrecent", "LNKRecent"},
